...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert2/11.10.6/sweetalert2.all.js"
        integrity="sha512-s6cmjAyURwCTwLDdp0oIw8QcQ7zdYioOWOoYACB7+Xmzrnc9VH1A8aUei32LafOWRiPiYJKSWSNoNg2WG5SBRA=="
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-[url('/public/assets/images/background/bg-element-3.jpg')] ">
        <nav
            class="fixed top-0 z-50 w-full bg-[url('/public/assets/images/background/bg-element-3.jpg')] border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <div class="ml-2">
                            <button id="theme-toggle" class="bg-orange-500 p-2.5 rounded-full" type="button"
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="{{ route('dashboard') }}"
                            ...
                            <svg class="w-5 h-5 text-slate-50 transition duration-75 group-hover:text-orange-500 dark:group-hover:text-orange-500"
                    ...
                    @if (auth()->user()->hasRole('Organizer'))
                        <li>
                            <a href="{{ route('reservations.index') }}"
                                class="flex items-center p-2 text-slate-50 rounded-lg dark:text-slate-50 hover:text-orange-500 hover:bg-slate-100 dark:hover:bg-gray-700 group {{ request()->routeIs('reservations.index') ? 'bg-orange-500 text-slate-50' : '' }}">
                                <svg class="flex-shrink-0 w-5 h-5 text-slate-50 transition duration-75 dark:text-slate-50 group-hover:text-orange-500 dark:group-hover:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path
                    ...
                    @if (auth()->user()->hasRole('Administrator'))
                        <li>
                            <a href="{{ route('users.index') }}"
                                class="flex items-center p-2 text-slate-50 rounded-lg dark:text-slate-50 hover:text-orange-500 hover:bg-slate-100 dark:hover:bg-gray-700 group {{ request()->routeIs('users.index') ? 'bg-orange-500 text-slate-50' : '' }} ">
                                <svg class="flex-shrink-0 w-5 h-5 text-slate-50 transition duration-75 dark:text-slate-50 group-hover:text-orange-500 dark:group-hover:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 20 18">
                                    <path
