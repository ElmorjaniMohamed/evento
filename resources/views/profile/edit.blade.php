                            ...
                            <div class="flex items-center rounded-md border-2 mx-1.5 my-5 px-6 py-5">
                                ...
                                <div class="w-2/5 justify-center">
                                    @if ($reservation->status === 'Confirmed')
                                        <a href=""
                                            class="text-slate-50 hover:text-slate-50 bg-orange-500 hover:bg-gradient-to-r from-orange-500 to-[#16005db7] w-fit px-3 py-2 rounded-full text-sm ml-4">Download</a>
                                    @else
